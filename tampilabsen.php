...
<head>
    ...
    <title>Absen Kelurahan Sekayu</title>
            ...
            <li class="nav-item mx-0 mx-lg-1">
              <form action="" method="POST">
                <div class="row">
                    ...
                    <div class="col-lg-auto ml-auto">
                        <input type="submit" class="btn btn-success btn-block" name="tampilsurat" value="Data Absen"/>
                    </div>
                    <div class="col-lg-auto ml-auto">
      ...
      <div class="container d-flex align-items-center flex-column">
        <div class="container">
          <table class="table table-striped table-bordered text-white caption">
            ...
            $sql = mysqli_query($db, "SELECT * FROM absen, pegawai WHERE absen.idpegawai=pegawai.id") or die(mysqli_error($db));
